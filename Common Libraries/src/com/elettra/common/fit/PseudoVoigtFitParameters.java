...
public final class PseudoVoigtFitParameters
{
	...
	public PseudoVoigtFitParameters(double amplitude, double center, double sigma, double shape, double offset)
	{
		super();
	...
	public PseudoVoigtFitParameters(double[] parameters)
	{
	...
	public double[] getParametersNoShape()
	{
